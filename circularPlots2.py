...
names = [['Permutation testing, subject-level',
          'Permutation testing, subject-level',
          'Permutation testing, subject-level',
          'Permutation testing, subject-level'],
         ['Permutation testing, cohort-level',
          'Permutation testing, cohort-level',
          'Permutation testing, cohort-level',
          'Permutation testing, cohort-level'],
         ['Mixture modeling, subject-level',
          'Mixture modeling, subject-level',
          'Mixture modeling, subject-level',
          'Mixture modeling, subject-level'],
         ['Mixture modeling, cohort-level',
          'Mixture modeling, cohort-level',
          'Mixture modeling, cohort-level',
          'Mixture modeling, cohort-level']]
names2 = ['permT1','permT2','MM1','MM2']
...
for num,idx1 in enumerate(['permT1','permT2','MM1','MM2']):
